# -*- coding: utf-8 -*-
"""Pred_Ref_LR, RF, XGB.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18BZPxS2iHDas5c1QnGInznNOsuAWrqro
...
#pip install catboost xgboost seaborn matplotlib scikit-learn
# %matplotlib inline
...
X_train.iloc[:, cat_features] = X_train.iloc[:, cat_features].astype(str)
X_validation.iloc[:, cat_features] = X_validation.iloc[:, cat_features].astype(str)
